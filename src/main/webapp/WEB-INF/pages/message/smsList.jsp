...
<body>
					...
					<div class="global_mod user_global_opr float_layout query_area">
						<div class="global_info" style="margin-right: -100px;">
							<div class="search_bar query_field" id="searchBar">
								...
								</a> <input type="text" value="" id="searchphone" name="searchphone"
							...
							<div class="search_bar query_field" id="searchBar">
								<label class="frm_input_box label">内容</label> <span
									...
									class="del_btn jsSearchInputClose" href="javascript:"
									style="display: none"> <i class="icon_search_del"></i>&nbsp;
								</a> <input type="text" value="" id="searchcontent"
									name="searchcontent" class="frm_input jsSearchInput"
									placeholder="请输入关键词">
								</span>
							</div>
									...
									<table class="table" cellspacing="0" style="width: 125%;">
										<thead class="thead">
											<tr>
												...
												<th class="table_cell">接收方</th>
												<th class="table_cell">短信标题</th>
												<th class="table_cell">短信内容</th>
										...
										<tbody class="tbody" id="userGroups">
											<c:forEach items="${smsList}" var="smsList"
												...
												<tr>
													...
													<td class="table_cell">${smsList.reception}</td>
													<td class="table_cell">${smsList.title}</td>
													<td class="table_cell">${smsList.content}</td>
													<td class="table_cell">${smsList.sendtime}</td>
													...
													<%
														...
														%>
													<a
														href="javascript:del('${smsList.id}');" class="mod_link js_tag_edit_btn">删除</a>
														<%}%>
														</td>
												</tr>
											</c:forEach>
	...
	<script type="text/javascript">
		...
		function search() {
			...
			temp.action = "../message/smslist.do";
			temp.method = "post";
				...
				$.ajax({
					...
					success : function(data) {
						...
						if (map != null) {
							if (map.success == "删除成功!") {
								alert(map.success);
								location.href = "../message/smslist.do";
							}
						}
					},
					error : function() {
