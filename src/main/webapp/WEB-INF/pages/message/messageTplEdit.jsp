...
<script type="text/javascript">
	function queding(){
		...
		if(tempid!=null){
			...
			temp.action = "../message/savemessagetemple.do";
			temp.method = "post";
				...
				<div class="col_main">
					...
					<div class="main_hd">
						...
						<div class="extra_info mini_tips icon_after">
					        <a href="history.go(-1)">返回</a><i class="icon_mini_tips document_link"></i>
						</div>
					</div>
					<!--导航区  end-->
					<!--页面主体 -->
							...
							<div class="bd">
				                <div class="table_wrp user_list">
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box search"> <input
														type="text" value="" id="tempname" name="tempname"
														class="frm_input jsSearchInput" placeholder="请输入模板标题">
													</span>
												</div>
											</td>
										</tr>
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box search textarea"> <textarea
															...
															placeholder="请输入您要设置的短信模板,例如：欢迎注册顺心会，验证码为｛验证码｝"></textarea>
													</span>
												</div>
											</td>
										</tr>
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box search textarea"> <textarea
															...
															class="frm_input jsSearchInput" placeholder=" 请输入备注内容"></textarea>
													</span>
												</div>
											</td>
										</tr>
				                	...
				                	<div class="tool_bar tc">
										...
										<a href="javascript:queding();" class="btn btn_primary js_complete_bnt">提交</a>
									</div>
				                </div>
							</div>
						</div>
