...
<script type="text/javascript">
	...
	function update(id) {
		...
		temp.action = "../message/updatemessagetemplates.do";
		temp.method = "post";
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (map != null) {
						if (map.success == "删除成功!") {
							alert(map.success);
							location.href = "../message/showmessagetemples.do";
						}
					}
				},
				error : function() {
...
<body>
					...
					<div class="global_mod  float_layout query_area">
						...
						<div class="global_extra">
							<a href="javascript:search();" data-y="3"
								...
								href="../message/addmessagetemple.do" data-y="3"
								class="btn btn_primary btn_add query_btn" id="js_tag_add_btn"><i
								class="icon14_common add_white"></i>新增站内信模板</a>
						</div>
					</div>
 ...
 %> <a class="mod_link js_tag_del_btn"
								...
								<!--分页条  
				                	<div class="tool_area">
					                    <div class="pagination_wrp js_pageNavigator"><div class="pagination" id="wxPagebar_1462287141558">
				...
				<div class="audio_box">
					<div class="audio_box_bd audio_list_container" id="">
						<div class="account_setting_area alert_content" id="settingArea">
							您正在<span id="dialog_action">删除</span>站内信模板
	...
	<script>
		...
		function search() {
			...
			var temp = document.createElement("form");
			temp.action = "../message/showmessagetemples.do";
			temp.method = "post";
			temp.style.display = "none";
			var opt = document.createElement("input");
			opt.name = "tempname";
