...
<body>
									...
									<tbody class="tbody" id="userGroups">
										<tr>
											...
											<td class="table_cell"><input type="text"
												...
												value="${activities.activitynum}" /></td>
										</tr>
										<tr>
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box search"> <input
														type="text" value="${activities.activityname}"
										...
										<tr>
											...
											<td class="table_cell"><span> <img id="yyzzpic"
													src="${purl}" alt="" width="600px" height="400px" /> <input
										...
										<tr>
											...
											<td class="table_cell">
											<script id="editor"
													type="text/plain" style="width:700px;height:500px;">${activities.activitydetail}</script>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box search"> <input
														type="text" id="activityadd" name="activityadd"
														value="${activities.activityadd}"
										...
										<tr>
											...
											<td class="table_cell">
												<div class="edit_input" id="searchBar">
													<span class="frm_input_box number"> <input
														type="text" value="${activities.activitycost}"
														id="activitycost" name="activitycost"
														class="frm_input jsSearchInput" placeholder="">
										...
										<tr>
											...
											<td class="table_cell left"><script id="editor1"
													type="text/plain" style="width:700px;height:500px;">${activities.activityflow}</script>
										            </td>
										</tr>
									</tbody>
								</table>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			temp.action = "../activity/saveupdateactivities.do";
			temp.method = "post";
			...
			var opt11 = document.createElement("input");
			opt11.name = "activityid";
			opt11.value = activityid;
			temp.appendChild(opt11);
			var opt12 = document.createElement("input");
			opt12.name = "activitynum";
			opt12.value = activitynum;
			temp.appendChild(opt12);
